...
* **include:** added missing SSL error include ([1877b11](https://github.com/bleenco/bproxy/commit/1877b11))
* **invalid-free:** fixed invalid free of connection ([85e53cc](https://github.com/bleenco/bproxy/commit/85e53cc))
...
* **tests:** unit in dd command based on os ([2446a73](https://github.com/bleenco/bproxy/commit/2446a73))
...
* **502-response:** added 502 response for unsuccessful server connection ([4972059](https://github.com/bleenco/bproxy/commit/4972059))
